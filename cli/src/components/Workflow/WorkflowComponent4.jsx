...
async function getResult(languages, frameworks) {
  let prompt = `Generate a structured JSON object that represents a progressive learning path in Data Science. The user knows the following languages: [${languages}]. The user also knows frameworks: [${frameworks}].
